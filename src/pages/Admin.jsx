...
function Admin() {
  ...
  const handleCropConfirm = async () => {
    try {
      ...
      const response = await fetch('https://flavr-backend-production.up.railway.app/api/upload-recipe-image', {
        method: 'POST',
        body: uploadData
      })
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editingId) {
        const response = await fetch(`https://flavr-backend-production.up.railway.app/api/recipes/${editingId}`, {
          method: 'PUT',
        ...
        const response = await fetch('https://flavr-backend-production.up.railway.app/api/recipes', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify(formData)
        })
  ...
  const confirmDeleteNow = async () => {
    try {
      const response = await fetch(`https://flavr-backend-production.up.railway.app/api/recipes/${confirmDeleteId}`, {
        method: 'DELETE'
      })
